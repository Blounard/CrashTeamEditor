...
public:
	...
	bool RenderUI();
	void SerializeInto(std::vector<uint8_t>& output, uint32_t modelOffset, size_t headerStructOffset,
...
public:
	...
	// Model ID
	ModelId GetModelID() const { return m_modelID; }
	...
	bool HasFlag(InstanceFlag flag) const { return (m_flags & static_cast<uint32_t>(flag)) != 0; }
