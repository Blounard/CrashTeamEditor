...
{
	TERRAIN, QUAD_FLAGS, DRAW_FLAGS, CHECKPOINT, TURBO_PAD, SPEED_IMPACT, WEATHER_INTENSITY, WEATHER_VANISH_RATE, CHECKPOINT_PATHABLE, VISTREE_TRANSPARENT, DRAW_ORDER_HIGH, WATER
};
